...
const createPengajuanSchema = z.object({
    ...
    tanggal_kembali: z.string().datetime().or(z.string()).optional().or(z.literal('')),
});
...
export async function POST(request: Request) {
    try {
        ...
        const { id_peminjam, items, alasan, tanggal_pinjam, tanggal_kembali } = validation.data;
        ...
        const parseDate = (d: string | undefined | null) => d ? new Date(d) : null;
