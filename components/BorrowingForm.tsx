          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Ketik keperluan barang disini..."
                    ...
                    {filteredProducts.map((product, index) => (
                      <tr key={product.id} style={{ borderBottom: '1px solid #E0E0E0' }}>
                        ...
                        <td style={{ padding: '12px' }}>
                          ...
                          >
                            <span className="desktop-add-btn-text">
                              {selectedProducts.some(p => p.id === product.id) ? 'Ditambahkan' : 'Tambahkan'}
                            </span>
                            <span className="mobile-add-btn-icon" style={{ display: 'none', alignItems: 'center', justifyContent: 'center' }}>
                              <iconify-icon icon={selectedProducts.some(p => p.id === product.id) ? "ic:baseline-check" : "ic:round-plus"} height="20" />
                            </span>
                          </button>
                        </td>
                      </tr>
